...
- `src/webapp/renderer.py`: bounding-box styling simplified to a single 1 px green line, removing the dark halo so annotations read more cleanly on the current CT viewer treatment
